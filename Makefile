...
favicons_generate: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./assets/icon.svg
	...
	npm exec --no --ignore-scripts -- tooling-favicons web ./assets/icon.svg ./build/favicons --apple-background '#fdf7ff'
	npm exec --no --ignore-scripts -- tooling-favicons pwa ./assets/icon.svg ./build/favicons --maskable-background '#fdf7ff' --maskable-fit safe
...
playwright_test_ui: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./tests/e2e/playwright.config.ts assets_generate
	npm exec --no --ignore-scripts -- playwright test --config ./tests/e2e/playwright.config.ts --ui --ui-host=0.0.0.0 --ui-port=62172
