...
icons: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./assets/icon.svg
	npm exec --ignore-scripts -- tooling-favicons web ./assets/icon.svg ./generated --background '#fdf7ff'
	npm exec --ignore-scripts -- tooling-favicons pwa ./assets/icon.svg ./assets/icon.svg ./generated --background '#fdf7ff' --maskable-fit source
...
playwright_ui: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./playwright.config.js icons
	npm exec --ignore-scripts -- playwright test --ui --ui-host=0.0.0.0 --ui-port=62172
