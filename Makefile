...
favicons_generate: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./assets/icon.svg
	...
	npm exec --no --ignore-scripts -- tooling-favicons web ./assets/icon.svg ./generated/favicons --apple-background '#fdf7ff'
	npm exec --no --ignore-scripts -- tooling-favicons pwa ./assets/icon.svg ./generated/favicons --maskable-background '#fdf7ff' --maskable-fit canvas
...
playwright_test_ui: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./playwright.config.js assets_generate
	npm exec --no --ignore-scripts -- playwright test --ui --ui-host=0.0.0.0 --ui-port=62172
