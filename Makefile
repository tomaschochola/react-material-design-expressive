...
icons: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./assets/icon.svg
	npm exec --ignore-scripts -- tooling-favicons web ./assets/icon.svg ./generated --apple-background '#fdf7ff'
	npm exec --ignore-scripts -- tooling-favicons pwa ./assets/icon.svg ./generated --maskable-background '#fdf7ff' --maskable-fit canvas
