...
DEVCONTAINER_PROJECT := react-material-design-expressive-devcontainer
...
icons: ./node_modules ./package.json ./package-lock.json ./assets/icons/icon.svg
	npm exec --ignore-scripts -- generate-icons ./assets/icons/icon.svg ./public fullbleed '#fdf7ff'
