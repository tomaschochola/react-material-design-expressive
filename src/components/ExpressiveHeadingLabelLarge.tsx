...
export interface ExpressiveHeadingLabelLargeProps extends Omit<ExpressiveHeadingProps, 'style'> {
...
export function ExpressiveHeadingLabelLarge({ level, top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveHeadingLabelLargeProps>) {
  return (
    <ExpressiveHeading
      style={{
