...
export interface ExpressiveHeadingLabelLargeProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingLabelLarge({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingLabelLargeProps) {
