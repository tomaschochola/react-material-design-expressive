...
export interface ExpressiveFontBodyLargeProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontBodyLarge({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontBodyLargeProps) {
  return (
    <span
      {...stylex.props(
