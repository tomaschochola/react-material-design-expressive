...
export interface ExpressiveHeadingDisplayLargeProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingDisplayLarge({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingDisplayLargeProps) {
