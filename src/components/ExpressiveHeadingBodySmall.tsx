...
export interface ExpressiveHeadingBodySmallProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingBodySmall({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingBodySmallProps) {
