...
export interface ExpressiveFontTitleLargeProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> {
...
export function ExpressiveFontTitleLarge({ top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveFontTitleLargeProps>) {
  return (
    <span
      style={{
