...
export interface ExpressiveFontTitleLargeProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontTitleLarge({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontTitleLargeProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.titleLarge,
        rootStyles.base,
