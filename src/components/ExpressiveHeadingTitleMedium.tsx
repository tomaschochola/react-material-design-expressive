...
export interface ExpressiveHeadingTitleMediumProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingTitleMedium({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingTitleMediumProps) {
