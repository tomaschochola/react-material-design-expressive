...
export interface ExpressiveHeadingDisplaySmallProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingDisplaySmall({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingDisplaySmallProps) {
