...
export interface ExpressiveHeadingDisplaySmallProps extends Omit<ExpressiveHeadingProps, 'style'> {
...
export function ExpressiveHeadingDisplaySmall({ level, top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveHeadingDisplaySmallProps>) {
  return (
    <ExpressiveHeading
      style={{
        ...expressivePresets.font.displaySmall,
        ...rootStyles.base,
