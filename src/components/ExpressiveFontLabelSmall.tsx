...
export interface ExpressiveFontLabelSmallProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> {
...
export function ExpressiveFontLabelSmall({ top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveFontLabelSmallProps>) {
  return (
    <span
      style={{
