...
export interface ExpressiveHeadingBodyLargeProps extends Omit<ExpressiveHeadingProps, 'style'> {
...
export function ExpressiveHeadingBodyLarge({ level, top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveHeadingBodyLargeProps>) {
  return (
    <ExpressiveHeading
      style={{
