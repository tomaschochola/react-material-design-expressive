...
export interface ExpressiveFontHeadlineSmallProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> {
...
export function ExpressiveFontHeadlineSmall({ top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveFontHeadlineSmallProps>) {
  return (
    <span
      style={{
