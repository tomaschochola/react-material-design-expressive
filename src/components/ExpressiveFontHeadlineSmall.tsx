...
export interface ExpressiveFontHeadlineSmallProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontHeadlineSmall({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontHeadlineSmallProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.headlineSmall,
        rootStyles.base,
