...
export interface ExpressiveOutlinedButtonProps extends Omit<AriaButtonProps, 'children' | 'style'> {
...
export function ExpressiveOutlinedButton({ symbol, label, style, ...props }: Readonly<ExpressiveOutlinedButtonProps>): ReactElement {
