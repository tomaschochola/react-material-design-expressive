...
export interface ExpressiveFontBodyMediumProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontBodyMedium({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontBodyMediumProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.bodyMedium,
        rootStyles.base,
