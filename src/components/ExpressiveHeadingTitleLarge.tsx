...
export interface ExpressiveHeadingTitleLargeProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingTitleLarge({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingTitleLargeProps) {
