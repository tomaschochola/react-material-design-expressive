...
export interface ExpressiveHeadingTitleLargeProps extends Omit<ExpressiveHeadingProps, 'style'> {
...
export function ExpressiveHeadingTitleLarge({ level, top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveHeadingTitleLargeProps>) {
  return (
    <ExpressiveHeading
      style={{
