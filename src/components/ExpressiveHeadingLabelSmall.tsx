...
export interface ExpressiveHeadingLabelSmallProps extends Omit<ExpressiveHeadingProps, 'style'> {
...
export function ExpressiveHeadingLabelSmall({ level, top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveHeadingLabelSmallProps>) {
  return (
    <ExpressiveHeading
      style={{
        ...expressivePresets.font.labelSmall,
        ...rootStyles.base,
