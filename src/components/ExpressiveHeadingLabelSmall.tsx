...
export interface ExpressiveHeadingLabelSmallProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingLabelSmall({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingLabelSmallProps) {
