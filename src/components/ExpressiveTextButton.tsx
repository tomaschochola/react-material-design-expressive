...
export interface ExpressiveTextButtonProps extends Omit<AriaButtonProps, 'children' | 'style'> {
...
export function ExpressiveTextButton({ symbol, label, style, ...props }: Readonly<ExpressiveTextButtonProps>): ReactElement {
