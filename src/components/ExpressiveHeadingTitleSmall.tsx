...
export interface ExpressiveHeadingTitleSmallProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingTitleSmall({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingTitleSmallProps) {
