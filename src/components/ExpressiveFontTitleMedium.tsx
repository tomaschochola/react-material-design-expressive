...
export interface ExpressiveFontTitleMediumProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> {
...
export function ExpressiveFontTitleMedium({ top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveFontTitleMediumProps>) {
  return (
    <span
      style={{
