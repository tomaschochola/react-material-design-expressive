...
export interface ExpressiveFontTitleMediumProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontTitleMedium({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontTitleMediumProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.titleMedium,
        rootStyles.base,
