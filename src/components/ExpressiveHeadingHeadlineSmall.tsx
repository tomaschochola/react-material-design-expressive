...
export interface ExpressiveHeadingHeadlineSmallProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingHeadlineSmall({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingHeadlineSmallProps) {
