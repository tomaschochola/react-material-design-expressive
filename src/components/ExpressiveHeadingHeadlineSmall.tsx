...
export interface ExpressiveHeadingHeadlineSmallProps extends Omit<ExpressiveHeadingProps, 'style'> {
...
export function ExpressiveHeadingHeadlineSmall({ level, top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveHeadingHeadlineSmallProps>) {
  return (
    <ExpressiveHeading
      style={{
