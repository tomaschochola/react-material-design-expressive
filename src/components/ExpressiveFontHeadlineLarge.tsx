...
export interface ExpressiveFontHeadlineLargeProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> {
...
export function ExpressiveFontHeadlineLarge({ top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveFontHeadlineLargeProps>) {
  return (
    <span
      style={{
