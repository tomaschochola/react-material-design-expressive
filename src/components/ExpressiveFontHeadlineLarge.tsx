...
export interface ExpressiveFontHeadlineLargeProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontHeadlineLarge({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontHeadlineLargeProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.headlineLarge,
        rootStyles.base,
