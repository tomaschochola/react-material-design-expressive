...
export interface ExpressiveTextLinkProps extends Omit<AriaLinkOptions, 'children' | 'style'> {
...
export function ExpressiveTextLink({ symbol, label, style, ...props }: Readonly<ExpressiveTextLinkProps>): ReactElement {
