...
export interface ExpressiveFontHeadlineMediumProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontHeadlineMedium({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontHeadlineMediumProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.headlineMedium,
        rootStyles.base,
