...
export interface ExpressiveFilledLinkProps extends Omit<LinkProps, 'style' | 'className' | 'children'> {
...
export function ExpressiveFilledLink({ symbol, xstyle, label, ...props }: ExpressiveFilledLinkProps) {
