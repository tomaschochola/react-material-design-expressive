...
export interface ExpressiveElevatedLinkProps extends Omit<LinkProps, 'style' | 'className' | 'children'> {
...
export function ExpressiveElevatedLink({ symbol, xstyle, label, ...props }: ExpressiveElevatedLinkProps) {
