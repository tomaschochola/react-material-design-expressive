...
export interface ExpressiveFontTitleSmallProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontTitleSmall({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontTitleSmallProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.titleSmall,
        rootStyles.base,
