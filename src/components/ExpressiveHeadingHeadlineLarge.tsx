...
export interface ExpressiveHeadingHeadlineLargeProps extends Omit<ExpressiveHeadingProps, 'style'> {
...
export function ExpressiveHeadingHeadlineLarge({ level, top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveHeadingHeadlineLargeProps>) {
  return (
    <ExpressiveHeading
      style={{
