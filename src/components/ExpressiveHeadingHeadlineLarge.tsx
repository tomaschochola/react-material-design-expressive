...
export interface ExpressiveHeadingHeadlineLargeProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingHeadlineLarge({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingHeadlineLargeProps) {
