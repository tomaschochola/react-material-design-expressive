...
export interface ExpressiveFontDisplayMediumProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontDisplayMedium({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontDisplayMediumProps) {
  return (
    <span
      {...stylex.props(
        expressivePresetFont.displayMedium,
        rootStyles.base,
