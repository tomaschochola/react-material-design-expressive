...
export interface ExpressiveFontLabelMediumProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> {
...
export function ExpressiveFontLabelMedium({ top, bottom, block, inline, children, style, ...props }: Readonly<ExpressiveFontLabelMediumProps>) {
  return (
    <span
      style={{
