...
export interface ExpressiveFontLabelMediumProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style' | 'className'> {
...
export function ExpressiveFontLabelMedium({ xstyle, top, bottom, block, inline, children, ...props }: ExpressiveFontLabelMediumProps) {
  return (
    <span
      {...stylex.props(
