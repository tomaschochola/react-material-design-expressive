...
export interface ExpressiveHeadingBodyMediumProps extends Omit<HeadingProps, 'style' | 'className'> {
...
export function ExpressiveHeadingBodyMedium({ xstyle, level, top, bottom, block, inline, children, ...props }: ExpressiveHeadingBodyMediumProps) {
