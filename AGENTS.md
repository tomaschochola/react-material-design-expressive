# react-material-design-expressive

React component library implementing Material Design 3 Expressive patterns and themes.

## Stack

- Language: TypeScript, React
- Runtime: Node 24 on GNU/Linux, browsers via Playwright
- Libraries: react 19.x, react-aria 3.x, react-stately 3.x, react-router 8.x, OpenTelemetry
- Package manager: npm
